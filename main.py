...
if __name__ == "__main__":
    image_path, image_result = make_image(image_link, image_theme) # Call the make_image function to generate the image and get the path and result
    music_path, music_result = make_music(image_path) # Call the make_music function to generate the music based on the image and get the path and result
